...
public class SHA512 {
	...
	public static void main(String args[]) throws NoSuchAlgorithmException, IOException {
		...
		MessageDigest SHA2Digest = MessageDigest.getInstance("SHA-512");//creating a message digest based on the SHA512 standard
		...
		System.out.println("SHA2-512 of file:" + getFileChecksum(SHA2Digest, file1));//making a call to getFileChecksum
